...
extern "C" IL2CPP_METHOD_ATTR void GenericPointer_OnPreRaycast_m3597384523 (GenericPointer_t429146605 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		RayStepU5BU5D_t3706455741* L_1 = GenericPointer_get_Rays_m958457738(__this, /*hidden argument*/NULL);
		NullCheck(L_1);
		Ray_t3785851493  L_2 = V_0;
		float L_3 = VirtFuncInvoker0< float >::Invoke(46 /* System.Single Microsoft.MixedReality.Toolkit.InputSystem.Pointers.GenericPointer::get_PointerExtent() */, __this);
		RayStep_CopyRay_m583328092((RayStep_t790153972 *)((L_1)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))), L_2, L_3, /*hidden argument*/NULL);
	}

IL_0022:
	{
		// if (RayStabilizer != null)
		RuntimeObject* L_4 = GenericPointer_get_RayStabilizer_m140003548(__this, /*hidden argument*/NULL);
		if (!L_4)
		{
			goto IL_0079;
		}
	}
	{
		...
		RayStepU5BU5D_t3706455741* L_6 = GenericPointer_get_Rays_m958457738(__this, /*hidden argument*/NULL);
		NullCheck(L_6);
		Vector3_t3722313464  L_7 = RayStep_get_Origin_m9912436((RayStep_t790153972 *)((L_6)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))), /*hidden argument*/NULL);
		RayStepU5BU5D_t3706455741* L_8 = GenericPointer_get_Rays_m958457738(__this, /*hidden argument*/NULL);
		NullCheck(L_8);
		Vector3_t3722313464  L_9 = RayStep_get_Direction_m1702894149((RayStep_t790153972 *)((L_8)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))), /*hidden argument*/NULL);
		NullCheck(L_5);
		InterfaceActionInvoker2< Vector3_t3722313464 , Vector3_t3722313464  >::Invoke(4 /* System.Void Microsoft.MixedReality.Toolkit.Core.Interfaces.Physics.IBaseRayStabilizer::UpdateStability(UnityEngine.Vector3,UnityEngine.Vector3) */, IBaseRayStabilizer_t1978348158_il2cpp_TypeInfo_var, L_5, L_7, L_9);
		...
		NullCheck(L_10);
		RuntimeObject* L_11 = GenericPointer_get_RayStabilizer_m140003548(__this, /*hidden argument*/NULL);
		NullCheck(L_11);
		Ray_t3785851493  L_12 = InterfaceFuncInvoker0< Ray_t3785851493  >::Invoke(2 /* UnityEngine.Ray Microsoft.MixedReality.Toolkit.Core.Interfaces.Physics.IBaseRayStabilizer::get_StableRay() */, IBaseRayStabilizer_t1978348158_il2cpp_TypeInfo_var, L_11);
		float L_13 = VirtFuncInvoker0< float >::Invoke(46 /* System.Single Microsoft.MixedReality.Toolkit.InputSystem.Pointers.GenericPointer::get_PointerExtent() */, __this);
		RayStep_CopyRay_m583328092((RayStep_t790153972 *)((L_10)->GetAddressAt(static_cast<il2cpp_array_size_t>(0))), L_12, L_13, /*hidden argument*/NULL);
	}
...
IL_0020:
	{
		...
		bool L_7 = GenericPointer_Equals_m1638976740(__this, ((RuntimeObject*)Castclass((RuntimeObject*)L_6, IMixedRealityPointer_t3090763169_il2cpp_TypeInfo_var)), /*hidden argument*/NULL);
		return L_7;
	}
}
// System.Boolean Microsoft.MixedReality.Toolkit.InputSystem.Pointers.GenericPointer::Equals(Microsoft.MixedReality.Toolkit.Core.Interfaces.InputSystem.IMixedRealityPointer)
...
IL_0020:
	{
		...
		RuntimeObject * L_6 = ___obj0;
		bool L_7 = BaseGenericInputSource_Equals_m1165034354(__this, ((RuntimeObject*)Castclass((RuntimeObject*)L_6, IMixedRealityInputSource_t86469781_il2cpp_TypeInfo_var)), /*hidden argument*/NULL);
		return L_7;
	}
}
// System.Boolean Microsoft.MixedReality.Toolkit.InputSystem.Sources.BaseGenericInputSource::Equals(Microsoft.MixedReality.Toolkit.Core.Interfaces.InputSystem.IMixedRealityInputSource)
